...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	// Mengakses service langsung dari r
	return resolvers.NewCategoryQueryResolver(r.CategoryService).Categories(ctx)
}

// Category is the resolver for the category field.
func (r *queryResolver) Category(ctx context.Context, id int32) (*model.Category, error) {
	// Mengakses service langsung dari r
	return resolvers.NewCategoryQueryResolver(r.CategoryService).Category(ctx, id)
}
